...
class Szornyek
{
  ...
  private function SzornyGen($szintek){
    ...
    for ($i = 0; $i < $szornydarab; $i++) {
      ...
      switch ($szintek[$i]) {
        case 1:  $tamadas[0] = 1; $tamadas[1] = 2; 
          break;
        case 2:  $tamadas[0] = 1; $tamadas[1] = 3;
          break;
        case 3:  $tamadas[0] = 2; $tamadas[1] = 4;
          break;
        case 4:  $tamadas[0] = 2; $tamadas[1] = 5;
          break;
        case 5: $tamadas[0] = 3; $tamadas[1] = 6;
          break;
